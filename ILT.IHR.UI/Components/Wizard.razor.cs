...
namespace ILT.IHR.UI.Components
{
    /// <summary>
    /// Wizard Component
    /// </summary>
    public partial class Wizard
    {
        ...
        {
            ILT.IHR.UI.Shared.WizardFlow wizardFlow = (ILT.IHR.UI.Shared.WizardFlow)ChildContent.Target;
            bool boolValue = wizardFlow.ValidateWizardData(ActiveStep.Name);
            if (boolValue == false && IsLastStep)
            {
                wizardFlow.SaveWizardData();
            }
